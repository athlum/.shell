...
export PATH=$PATH:/usr/local/go/bin:/Users/$user/dev/workspace/bin:/opt/apache-maven-3.6.3/bin:/usr/local/bin
export PATH=$PATH:/usr/local/kubebuilder/bin
export PATH=$PATH:/Users/$user/Library/Python/2.7/bin
alias gh="cd /Users/$user/dev/workspace/src/github.com/athlum"
...
alias vi="/usr/local/Cellar/neovim/0.4.3/bin/nvim"
...
alias at="echo -n \"$(date +%y%m%d%H)\"'APPCENTER#Da3s64547r667to89j' | md5sum | cut -d' ' -f1"
